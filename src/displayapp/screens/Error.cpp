...
Error::Error(Pinetime::Applications::DisplayApp* app, System::BootErrors error) : Screen(app) {
  ...
  lv_label_set_text_static(warningLabel, "Attenzione");
  ...
  if (error == System::BootErrors::TouchController) {
    lv_label_set_text_static(causeLabel, "Errore del touch rilevato.");
  }
  ...
  lv_label_set_text_static(tipLabel, "Se riscotri dei problemi e il tuo dispositivo e' sotto garanzia, contatta il venditore.");
  ...
  lv_label_set_text_static(lblOk, "Procedi");
