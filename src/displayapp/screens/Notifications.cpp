...
Notifications::Notifications(DisplayApp* app,
  ...
  if (mode == Modes::Preview) {
    ...
    lv_obj_set_style_local_line_color(timeoutLine, LV_LINE_PART_MAIN, LV_STATE_DEFAULT, Colors::highlight);
...
Notifications::NotificationItem::NotificationItem(const char* title,
  ...
  lv_obj_set_style_local_text_color(alert_type, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, LV_COLOR_WHITE);
  if (title == nullptr) {
