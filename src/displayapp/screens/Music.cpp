...
Music::Music(Pinetime::Controllers::MusicService& music) : musicService(music) {
  ...
  lv_style_set_bg_color(&btn_style, LV_STATE_DEFAULT, Colors::highlight);
  ...
  lv_label_set_text_static(txtArtist, "Nome artista");
  ...
  lv_label_set_text_static(txtTrack, "Questo e' un titolo veramente lungo");
